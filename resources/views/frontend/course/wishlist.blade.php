                                                ...
                                                <div class="card-item card-preview">
                                                    ...
                                                    <div class="card-content">
                                                        <p class="card__label">
                                                            ...
                                                            @auth()
                                                            <a href="#!" class="card__collection-icon primary-color-2"
                                                        ...
                                                        <h3 class="card__title">
                                                            <a
                                                                href="{{route('course.single',$item->course->slug)}}">{{\Illuminate\Support\Str::limit($item->course->title,58)}}</a>
                                                        </h3>
                                                        <p class="card__author">
                                                            <a
                                                                href="{{route('single.instructor',$item->course->relationBetweenInstructorUser->slug)}}">{{$item->course->relationBetweenInstructorUser->name}}</a>
                                                        </p>
                                                        ...
                                                        <div
                                                            ...
                                                            <span
                                                                class="price-before">{{formatPrice($item->course->discount_price)}}</span>
                                                            <span
                                                                class="price-current"><del>{{formatPrice($item->course->price)}}</del></span>
                                                            @else
                                                            <span
                                                            ...
                                                            'Student')
                                                            <a href="#!" class="text-btn addToCart-{{$item->id}}"
                                                                onclick="addToCart({{$item->course->id}},'{{route('add.to.cart')}}')">@translate(Ikuti
                                                                Pelatihan)</a>
                                                            @endif
