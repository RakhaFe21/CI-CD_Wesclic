                                    ...
                                    <div class="card-item card-preview"
                                        ...
                                        <div class="card-image">
                                            <a href="{{ route('course.single', $l_course->slug) }}"
                                                class="card__img"><img src="{{ filePath($l_course->image) }}"
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="rating-wrap d-flex mt-2 mb-3">
                                                <span class="star-rating-wrap">
                                                    ...
                                                    - <span
                                                        class="star__count">{{ \Carbon\Carbon::parse($l_course->berakhir_pendaftaran)->format('d F Y') }}</span>
                                                </span>
                                            </div><!-- end rating-wrap -->
                                            <div class="rating-wrap d-flex mt-2 mb-3">
                                                <div
                                            ...
                                            <div class="card-action">
                                                <ul class="card-duration d-flex justify-content-between align-items-center">
                                                    ...
                                                    <li>
                                                        <span class="meta__date">
                                                            <i class="la la-calendar"></i>
                                                            {{ \Carbon\Carbon::parse($l_course->tanggalwawancara)->format('d F Y') }}
                                                        </span>
                                                    </li>
                                                </ul>
                                            </div><!-- end card-action -->
                                            ...
                                            <div class="card-price-wrap d-flex justify-content-between align-items-center">
                                                ...
                                                @else
                                                    @if ($l_course->is_discount)
                                                        <span
                                                            class="card__price">{{ formatPrice($l_course->discount_price) }}</span>
                                                        <span
                                                            class="card__price"><del>{{ formatPrice($l_course->price) }}</del></span>
                                                    @else
                                                        <span
                                                        ...
                                                        <div class="card-item card-preview"
                                                            ...
                                                            <div class="card-image">
                                                                ...
                                                                @if (bestSellingTags($course->id))
                                                                    <div class="card-badge">
                                                                        <span class="badge-label">@translate(paling
                                                                            laris)</span>
                                                                    </div>
                                                                @endif
                                                            </div><!-- end card-image -->
                                                            <div class="card-content">
                                                                <p class="card__label">
                                                                    ...
                                                                    @guest()
                                                                        <a href="{{ route('login') }}"
                                                                            class="card__collection-icon" data-toggle="tooltip"
                                                                ...
                                                                <h3 class="card__title">
                                                                    <a
                                                                        href="{{ route('course.single', $course->slug) }}">{{ Str::limit($course->title, 58) }}</a>
                                                                </h3>
                                                                <p class="card__author">
                                                                    <a
                                    ...
                                    <div class="card-item card-preview"
                                        ...
                                        <div class="card-image">
                                            <a href="{{ route('course.single', $t_courses->slug) }}"
                                                class="card__img"><img src="{{ filePath($t_courses->image) }}"
                                            ...
                                            <div class="card-action">
                                                <ul
                                                    ...
                                                    <li>
                                                        <span class="meta__date">
                                                            <i class="la la-play-circle"></i>
                                                            {{ $t_courses->logbook->count() }} Materi
                                                        </span>
                                                    </li>
                                                    {{-- <li>
                                                        <span class="meta__date">
                                            ...
                                            <div class="card-price-wrap d-flex justify-content-between align-items-center">
                                                ...
                                                @else
                                                    @if ($t_courses->is_discount)
                                                        <span
                                                            class="card__price">{{ formatPrice($t_courses->discount_price) }}</span>
                                                        <span
                                                            class="card__price"><del>{{ formatPrice($t_courses->price) }}</del></span>
                                                    @else
                                                        <span
