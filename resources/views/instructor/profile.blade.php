                        ...
                        <div class="tab-pane fade show active" id="information" role="tabpanel"
                            ...
                            <div class="widget-body">
                                ...
                                <div class="form-group row d-flex align-items-center mb-5">
                                    <label
                                        class="col-lg-2 form-control-label d-flex justify-content-lg-end">@translate(Phone)</label>
                                    <div class="col-lg-6">
                                        <input type="tel" name="phone" class="form-control" placeholder="+88 987 654 32"
                                            value="{{ $each_user->phone }}">
                                    </div>
                                </div>
                                <div class="form-group row d-flex align-items-center mb-5">
                                    <label
                                        class="col-lg-2 form-control-label d-flex justify-content-lg-end">@translate(Address)</label>
                                    <div class="col-lg-6">
                                ...
                                <div class="form-group row d-flex align-items-center mb-5">
                                    <label
                                        class="col-lg-2 form-control-label d-flex justify-content-lg-end">@translate(Linkedin)</label>
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="linked" placeholder="Linkedin)"
                                            value="{{ $each_user->linked }}">
                                    </div>
                                </div>
                                <div class="form-group row d-flex align-items-center mb-5">
                                    <label
                                        class="col-lg-2 form-control-label d-flex justify-content-lg-end">@translate(Facebook)</label>
                                    <div class="col-lg-6">
                                ...
                                <div class="form-group row d-flex align-items-center mb-5">
                                    <label
                                        class="col-lg-2 form-control-label d-flex justify-content-lg-end">@translate(Twitter)</label>
                                    <div class="col-lg-6">
                                ...
                                <div class="form-group row d-flex align-items-center mb-5">
                                    <label
                                        class="col-lg-2 form-control-label d-flex justify-content-lg-end">@translate(Skype)</label>
                                    <div class="col-lg-6">
                                ...
                                <div class="form-group row d-flex align-items-center mb-5">
                                    <label
                                        class="col-lg-2 form-control-label d-flex justify-content-lg-end">@translate(About)</label>
                                    <div class="col-lg-6">
                                        <textarea class="form-control" name="about">{!! $each_user->about !!}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row d-flex align-items-center mb-5">
                            ...
                            <div class="em-separator separator-dashed">
                                <div class="text-right">
                                    <button class="btn btn-shadow btn-primary" type="submit">@translate(Save
                                        Changes)</button>
