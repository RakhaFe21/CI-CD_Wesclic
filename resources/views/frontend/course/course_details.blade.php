        ...
        <div class="preview-course-content">
            ...
            <div class="buy-course-btn mb-3 text-center">
                ...
                <a href="#!" class="theme-btn w-100 mb-3 addToCart-{{$s_course->id}}"
                    onclick="addToCart({{$s_course->id}},'{{route('add.to.cart')}}')">@translate(Ikuti Pelatihan)</a>
                @else
                <a href="{{route('login')}}" class="theme-btn w-100 mb-3">@translate(Ikuti Pelatihan)</a>
                @endif
                @endauth
                @guest
                <a href="{{route('login')}}" class="theme-btn w-100 mb-3">@translate(Ikuti Pelatihan)</a>
...
<div id="mobile-sidebar-feature" class="sidebar-widget sidebar-feature">
    <h3 class="widget-title">@translate(Fitur Pelatihan)</h3>
    <span class="section-divider"></span>
    <ul class="list-items">
        <li>
            <span><i class="la la-clock-o"></i>@translate(Durasi)</span>
        ...
        <li>
            <span><i class="la la-play-circle-o"></i>@translate(Pengajar)</span>
        ...
        <li>
            <span><i class="la la-level-up"></i>@translate(Level Kemampuan)</span>
            <span>{{ $s_course->level }}</span>
        </li>
        <li>
            <span> <i class="la la-users"></i>@translate(Siswa)</span>
...
<section class="course-detail margin-bottom-110px">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <div class="course-detail-content-wrap margin-top-100px">
                    ...
                    <div class="requirement-wrap margin-bottom-40px">
                        <h3 class="widget-title">@translate(Syarat)</h3>
                                        ...
                                        <div class="card-header" id="headingOne">
                                            <h2 class="mb-0">
                                                <button
                                                    ...
                                                    {{ $item->title }}
                                                    <span>{{ $item->contents->count() }} @translate(pengajar)</span>
                                                </button>
                                            </h2>
                                        </div><!-- end card-header -->
                                                        ...
                                                        <a href="javascript:void(0)"
                                                            ...
                                                            <span><i class="fa fa-play-circle mr-2"></i>{{
                                                                ...
                                                                <a href="javascript:void(0)"
                                                                    ...
                                                                    <span
                                                                        class="course-duration">{{duration($content->duration)}}
                                                                    </span>
                                                                </a>

                                                    </li>
                                                    @empty
                                                    @translate(Tidak ada konten)
                                                    @endforelse
                                                </ul>
                                            </div><!-- end card-body -->
                                        </div><!-- end collapse -->
                        ...
                        <div id="tooltip_content_{{$tooltip->id}}">
                            <div class="card-item">
                                <div class="card-content">
                                    ...
                                    <h3 class="card__title">
                                        <a
                                            href="{{route('course.single',$tooltip->slug)}}">{{\Illuminate\Support\Str::limit($tooltip->title,58)}}</a>
                                    </h3>
                                    <p class="card__label">
                                    ...
                                    <div class="card-action">
                                        <ul class="card-duration d-flex justify-content-between align-items-center">
                                            <li><span class="meta__date"><i class="la la-play-circle"></i>
                                                    {{$tooltip->classes->count()}} @translate(Kelas)</span>
                                            </li>
                    ...
                    <div class="instructor-wrap padding-top-50px padding-bottom-45px">
                        ...
                        <div class="instructor-content margin-top-30px d-flex">
                            <div class="instructor-img">
                                <a href="{{route('single.instructor',$s_course->slug)}}" class="instructor__avatar">
                                    <img data-original="{{ filePath($s_course->image) }}" alt="{{$s_course->name}}">
                                </a>
                                <ul class="list-items">
                                    </li>
                                    <li><span class="la la-user"></span> {{
                                        App\Model\Enrollment::where('course_id',$s_course->id)->count() }}
                                        @translate(Siswa)
                                    </li>
                                    <li><span class="la la-play-circle-o"></span> {{
                                        \App\Model\Course::where('user_id',$s_course->id)->count() }}
                                        @translate(Pelatihan)
                                    </li>
                                    <li><span class="la la-eye"></span>
                                        <a href="{{route('single.instructor',$s_course->slug)}}">
                                            @translate(Lihat Semua Pelatihan)</a>
                                    </li>
                                </ul>
                            </div><!-- end instructor-img -->
                            <div class="instructor-details">
                                <div class="instructor-titles">
                                    <h3 class="widget-title"><a href="{{route('single.instructor',$s_course->slug)}}">{{
                                            $s_course->name }}</a>
                                    </h3>
                                    <p class="instructor__subtitle">{{
                                        \Illuminate\Support\Carbon::parse($s_course->created_at)->diffForHumans() }}</p>
                                ...
                                <div class="instructor-desc">
                                    ...
                                    <div class="btn-box pt-2 d-inline-block">
                                        <a class="collapsed link-collapsed" data-toggle="collapse"
                                            ...
                                            <span class="link-collapse-active">@translate(Baca lebih sedikit)</span>
                                            <div class="ml-1">
                    ...
                    <div class="view-more-courses mt-5">
                        ...
                        <div class="view-more-carousel margin-top-30px margin-bottom-50px">
                            @foreach
                            (App\Model\Course::Published()->where('user_id',$s_course->user_id)->latest()->take(6)->get()
                            as $moreCourseItem)
                            <div class="column-td-half">
                                <div class="card-item card-preview"
            ...
            @foreach(App\Model\Course::Published()->where('user_id',$s_course->user_id)->latest()->get()->take(6) as
            $tooltip)
            <div class="tooltip_templates">
                <div id="tooltip_content_{{$tooltip->id}}">
                    <div class="card-item">
                        <div class="card-content">
                            ...
                            <div class="card-action">
                                <ul class="card-duration d-flex justify-content-between align-items-center">
                                    <li><span class="meta__date"><i class="la la-play-circle"></i>
                                            {{$tooltip->classes->count()}} @translate(Kelas Pelatihan)</span>
                                    </li>
                                    <li><span class="meta__date">
                                            @php
                                            $total_duration = 0;
                ...
                <div class="sidebar-component">
                    <div class="sidebar">
                        <div id="sidebar-preview" class="sidebar-widget sidebar-preview">
                            <div class="sidebar-preview-titles">
                                <h3 class="widget-title">@translate(Lihat kursus ini)</h3>
                                <span class="section-divider"></span>
                            </div>
                            <div class="preview-video-and-details">
                                <div class="preview-course-video">
                                ...
                                <div class="preview-course-content">
                                    ...
                                    <div class="buy-course-btn mb-3 text-center">
                                        ...
                                        @if(\Illuminate\Support\Facades\Auth::user()->user_type == 'Student')
                                        <a href="#!" class="theme-btn w-100 mb-3 addToCart-{{$s_course->id}}"
                                            onclick="addToCart({{$s_course->id}},'{{route('add.to.cart')}}')">@translate(Ikuti
                                            Pelatihan)</a>
                                        @else
                                        <a href="{{route('login')}}" class="theme-btn w-100 mb-3">@translate(Ikuti
                                            Pelatihan)</a>
                                        @endif
                                        @endauth
                                        @guest
                        ...
                        <div id="sidebar-feature" class="sidebar-widget sidebar-feature">
                            <h3 class="widget-title">@translate(Fitur Kursus)</h3>
                            <span class="section-divider"></span>
                            <ul class="list-items">
                                <li>
                                    <span><i class="la la-clock-o"></i>@translate(Durasi)</span>
                        ...
                        <div class="sidebar-widget recent-widget">
                            <h3 class="widget-title">@translate(Pelatihan Terakhir)</h3>
                            <span class="section-divider"></span>
                            ...
                            <div class="recent-item">
                                <div class="recent-img">
                                    <a href="{{route('course.single',$l_course->slug)}}">
                                        <img data-original="{{ filePath($l_course->image) }}"
                                            alt="{{$l_course->titlw}}">
                                    </a>
                                </div><!-- end recent-img -->
                                <div class="recentpost-body">
                                    <span class="recent__meta"> {{ $l_course->created_at->format('d M, Y') }}
                                        @translate(oleh) <a href="{{route('single.instructor',$l_course->slug)}}">{{
                                            $l_course->name }}</a></span>
                                    <h4 class="recent__link">
                                        <a href="{{route('course.single',$l_course->slug)}}">{{\Illuminate\Support\Str::limit($l_course->title,58)
                                            }}</a>
                                    </h4>
                            ...
                            <div class="btn-box text-center">
                                <a href="{{route('course.filter')}}" class="theme-btn d-block">@translate(Lihat Semua
                                    Pelatihan)</a>
                            </div><!-- end btn-box -->
                        </div><!-- end sidebar-widget -->
    ...
    <div class="modal fade preview-modal-form" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-top">
                    <h5 class="modal-title">@translate(Lihat Kursus): {{ $s_course->title }}</h5>
