    ...
    <div class="container-fluid">
        <div class="main-menu-content">
            <div class="row align-items-center h-100">
                <div class="col-lg-3">
                    <div class="logo-box">
                        <a href="{{ route('homepage') }}" class="w-50" title="{{getSystemSetting('type_name')->value}}">
                        ...
                        <div class="header-category">
                            <ul>
                                <li>
                                    <a href="{{ route('course.filter') }}"><i
                                            class="fa fa-th p-2"></i>@translate(Kategori)</a>
                            ...
                            <form>
                                <div class="input-box">
                                    <div class="form-group">
                                        ...
                                        {{--some ajax value--}}
                                        <input value="@translate(Keranjang anda kosong)" type="hidden" id="emptyUrl"
                                            name="emptyUrl">
                                        <input value="{{route('search.courses')}}" type="hidden" id="searchUrl"
                                            name="searchUrl">
                        ...
                        <div class="logo-right-button">
                            ...
                            <div class="header-action-button d-flex align-items-center">
                                ...
                                <div class="notification-wrap d-flex align-items-center ml-3">
                                    <div class="notification-item mr-3 cart_item">
                                        ...
                                        <div id="mySidebar" class="cart-sidebar">
                                            ...
                                            <div class="cart_sidebar">
                                                <input id="cartImg" name="cartImg" type="hidden"
                                                    value="{{ asset('frontend/images/empty_cart.png') }}">
                                                <ul id="cartAppend">
                                                ...
                                                <input value="{{route('cart.list')}}" type="hidden" id="cartUrl"
                                                    name="cartUrl">
                                                <input value="{{route('wish.list')}}" type="hidden" id="wishUrl"
                                                    name="wishUrl">
                                                <input value="{{route('enroll.courses')}}" type="hidden" id="enrollUrl"
                                                    name="enrollUrl">
                                                <input value="{{route('shopping.cart')}}" type="hidden"
                                                    id="shoppingCart" name="shoppingCart">
                                                <input value="@translate(Ke Keranjang)" type="hidden" id="textUrl"
                                                    name="textUrl">
                                                ...
                                                <div id="cartBtn">
                                                    <a href="{{route('course.filter')}}"
                                                        class="theme-btn cart-btn btn-cart cart-text f-13 w-50">@translate(Daptkan
                                                        Pelatihanmu)</a>
                                                </div>
                                    ...
                                    <div class="notification-item mr-3 notify_btn">
                                        ...
                                        <button class="notification-btn" type="button" onclick="notifySidebaropenNav()">
                                            <i class="la la-bell"></i>
                                            <span class="quantity">{{
                                                App\NotificationUser::where('user_id',Auth::user()->id)->where('is_read',false)->count()
                                                }}</span>
                                        </button>
                                        ...
                                        <div id="notifySidebar" class="cart-sidebar">
                                            ...
                                            <div class="cart_sidebar">
                                                ...
                                                <ul class="list-group">
                                                    ...
                                                    <li>
                                                        @forelse
                                                        (App\NotificationUser::where('user_id',Auth::user()->id)->where('is_read',false)->latest()->get()
                                                        as $notification)
                                                        ...
                                                        <div class="content text-center no-notify">
                                                            <img src="{{ asset('frontend/images/notify.png') }}"
                                                                class="w-100" alt="">
                                                        </div>
                                                        ...
                                                        <a href="{{ route('student.dashboard') }}"
                                                            class="cart-btn btn-cart cart-text notify-btn f-13 w-50 mt-3">@translate(Lihat
                                                            Semua Notifikasi)</a>
                                    ...
                                    <div class="notification-item mr-3 wishlist_btn">
                                        ...
                                        <div id="wishSidebar" class="cart-sidebar">
                                            ...
                                            <div class="text-center">
                                                <h3>@translate(Daftar Keinginanmu)</h3>
                                                <hr>
                                            </div>


                                            <div class="cart_sidebar">
                                                <input id="wishtImg" name="wishImg" type="hidden"
                                                    value="{{ asset('frontend/images/wishlist.png') }}">
                                                <ul id="wishlistAppend">
                                                    <img src="{{ asset('frontend/images/wishlist.png') }}" class="w-100"
                                                        alt="">
                                                </ul>
                                                <div id="cartBtn">
                                                    <a href="{{ route('my.wishlist') }}"
                                                        class="theme-btn cart-btn cart-text w-75">@translate(Tampilkan
                                                        Semua Daftar Keinginanmu)</a>
                                                </div>
                                        ...
                                        <div class="dropdown">
                                            <button class="notification-btn dot-status online-status dropdown-toggle"
                                                ...
                                                <img src="{{ \Illuminate\Support\Facades\Auth::user()->image == null
                                                    ...
                                                    alt="{{ Auth::user()->name }}" class="avatar-sm rounded-circle">
                                            </button>
                                                ...
                                                <div class="mess-dropdown">
                                                    <div class="mess__title d-flex align-items-center">
                                                        ...
                                                        <div class="content ml-8">
                                                            ...
                                                            @if (walletActive())
                                                            <span class="email"><i class="fa fa-money"></i> {{
                                                                walletBalance() }}</span>
                                                            @endif
                                                        ...
                                                        <ul class="list-items">
                                                            ...
                                                            <li class="mb-0">
                                                                <a href="{{route('my.courses')}}" class="d-block">
                                                                    ...
                                                                    @translate(Pelatihan saya)
                                                                </a>
                                                            </li>

                                                            <li class="mb-0">
                                                                <a href="{{route('student.message')}}" class="d-block">
                                                                    <i class="la la-bell"></i>
                                                                    @translate(Pesan)
                                                                </a>
                                                            </li>
                                                            ...
                                                            @if(affiliateStatus())
                                                            <li class="mb-0">
                                                                <a href="{{ route('affiliate.area') }}" class="d-block">
                                                                    <i class="la la-adn"></i>
                                                        ...
                                                        <ul class="list-items">
                                                            ...
                                                            <li class="mb-0">
                                                                <a href="{{ route('dashboard') }}" class="d-block">
                                                                    <i class="la la-dashboard"></i> @translate(Pergi Ke
                                                                    Dashboard)
                                                                </a>
                                                            </li>
                                        ...
                                        <ul class="user-cart d-flex align-items-center ">
                                            <li class="p-50p">
                                                <a href="{{route('dashboard')}}"
                                                    class="theme-btn text-white ">@translate(Pergi Ke Dashboard)</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <div class="mess-dropdown">
                                                    ...
                                                    <div class="mess__body">
                                                        <ul class="list-items">
                                                            ...
                                                            <li class="mb-0">
                                                                <a href="{{ route('media.index') }}" class="d-block">
                                                                    <i class="la la-video-camera"></i> @translate(Media
                                                                    Manager)
                                                                </a>
                                                            </li>
                                                            ...
                                                            <li class="mb-0">
                                                                <a href="{{ route('addons.manager.index') }}"
                                                                    class="d-block">
                                                                    <i class="la la-puzzle-piece"></i> @translate(Addons
                                                                    Manager)
                                                                </a>
                                                            </li>
                                                            ...
                                                            <li class="mb-0">
                                                                <a href="{{route('affiliate.setting.create')}}"
                                                                    class="d-block">
                                                                    <i class="la la-chain"></i> @translate(Affiliate
                                                                    Area)
                                                                </a>
                                                            </li>
                                                            ...
                                                            <li class="mb-0">
                                                                <a href="{{route('tickets.index')}}" class="d-block">
                                                                    <i class="la la-ticket"></i> @translate(Tiket
                                                                    Bantuan)
                                                                </a>
                                                            </li>
                            ...
                            <div class="menu-toggler d-flex align-items-center">
                                ...
                                <div class="user-menu-open ml-2">
                                    <a href="{{ route('student.profile') }}" class="d-block user-avatar-sm">
                        ...
                        <div class="logo-right-button">
                            <ul id="custom_toggle_bar" class="d-flex">
                                ...
                                <li><a href="{{route('student.register')}}"
                                        class="theme-btn student-btn">@translate(Daftar Peserta)</a></li>
                            </ul>
                            <div class="side-menu-open">
                                <i class="la la-bars"></i>
                            </div>
                        ...
                        <div class="side-nav-container">
                            ...
                            <div class="side-menu-wrap">
                                        ...
                                        <ul class="side-sub-menu">
                                            ...
                                            <li class="sidenav__item">
                                                ...
                                                <ul class="side-sub-menu">
                                                    @foreach($item->child as $child)
                                                    <li>
                                                        <a href="{{route('course.category',$child->slug)}}"
                                                            class="pl-55">{{$child->name}}</a>
                                                    </li>
                                                    @endforeach
                                                </ul>
                                                @endif
                                    ...
                                    <li class="sidenav__item">
                                        <a href="{{ route('logout') }}"
                                            onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">@translate(Keluar)</a>
                                ...
                                <div class="side-btn-box">
                                    <a href="{{ route('login') }}" class="theme-btn">@translate(Masuk)</a>
                                    <span>or</span>
                                    <a href="{{ route('student.register') }}" class="theme-btn">@translate(Daftar)</a>
                                </div>
                                @endguest
    ...
    <li class="nav-item">
        <div class="notification-item mr-3">
            <a href="{{ route('my.wishlist') }}">
                <button class="notification-btn dropdown-toggle">
                    <i class="la la-heart-o"></i>
                    <span class="quantity wishlist-quantity">{{
                        App\Model\Wishlist::where('user_id',Auth::user()->id)->count() }}</span>
                </button>
            </a>
        </div>
    </li>
