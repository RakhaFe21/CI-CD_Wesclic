                ...
                <div class="breadcrumb-content instructor-bread-content d-flex align-items-center">
                    <div class="section-heading">
                        ...
                        <p class="section__desc mb-2">
                            @translate(Tergabung) {{ $instructor->created_at->diffForHumans() }}</p>
                    </div>
...
<section class="team-detail-area section-padding">
    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="team-single-item">
                                    <ul class="address-list">
                                        @if($instructor->phone)
                                        <li><a href="tel:{{ $instructor->phone }}"><i class="la la-phone"></i>{{
                                                $instructor->phone }}</a>
                                        </li>
                                        @endif
                                        @if($instructor->email)
                                        <li><a href="mailto:{{ $instructor->email }}"><i class="la la-envelope-o"></i>{{
                                                $instructor->email }}</a></li>
                                        @endif
                                    </ul>
                                </div>
                            </div><!-- end col-lg-6 -->
                            <div class="col-lg-6">
                                <div class="team-single-item">
                                    <ul class="address-list">
                                        @if($instructor->fb)
                                        <li><a href="{{ $instructor->fb }}"><i
                                                    class="fa fa-facebook"></i>@translate(Facebook)</a>
                                        </li>
                                        @endif
                                        @if($instructor->tw)
                                        ...
                                        <li><a href="{{ $instructor->linked }}"><i class="fa fa-linkedin"></i>Linked
                                                In</a>
                                        </li>
                                        @endif

                                        @if($instructor->skype)
                                        <li><a href="{{ $instructor->skype }}"><i class="fa fa-skype"></i>Skype</a></li>
                                        @endif
                                    </ul>
                                </div>
                            </div><!-- end col-lg-6 -->
                            ...
                            <div class="col-lg-12 column-td-half">
                                <div class="team-single-item">
                                    ...
                                    <p class="number-count">
                                        <span class="counter">{{
                                            App\Model\Course::where('user_id',$instructor->user_id)->count() }}</span>
                                    </p>
        ...
        <div class="instructor-all-course padding-top-60px">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="widget-title pb-3">@translate(Pelatihan dimentori oleh) {{ $instructor->name }}</h3>
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-4">
                    <div class="column-td-half">
                        <div class="card-item card-preview" data-tooltip-content="#tooltip_content_{{$i_course->id}}">
                            <div class="card-image">
                                <a href="{{route('course.single',$i_course->slug)}}" class="card__img"><img
                                        src="{{ filePath($i_course->image) }}" alt="{{$i_course->title}}"></a>
                            ...
                            <div class="card-content">
                                <p class="card__label">
                                    ...
                                    @auth()
                                    <a href="#!" onclick="addToCart({{$i_course->id}},'{{route('add.to.wishlist')}}')"
                    ...
                    <div id="tooltip_content_{{$i_tooltip->id}}">
                        <div class="card-item">
                            <div class="card-content">
                                <p class="card__author">
                                    @translate(Oleh) <a
                                        href="{{route('single.instructor',$i_tooltip->slug)}}">{{$i_tooltip->name}}</a>
                                </p>
                                <h3 class="card__title">
                                    <a
                                        href="{{route('course.single',$i_tooltip->slug)}}">{{\Illuminate\Support\Str::limit($i_tooltip->title,58)}}</a>
                                </h3>
                                <p class="card__label">
                                ...
                                <div class="card-action">
                                    <ul class="card-duration d-flex justify-content-between align-items-center">
                                        <li><span class="meta__date"><i class="la la-play-circle"></i>
                                                {{$i_tooltip->classes->count()}} @translate(Kelas Pelatihan)</span>
                                        </li>
                                ...
                                <div class="btn-box w-100 text-center mb-3">
                                    <a href="{{route('course.single',$i_tooltip->slug)}}" class="theme-btn d-block">
