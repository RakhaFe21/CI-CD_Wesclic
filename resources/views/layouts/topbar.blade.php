                                    ...
                                    <ul class="list-unstyled lms-notify">
                                        ...
                                        @empty
                                            ...
                                            <li class="notification-dropdown-title stit-notification">
                                                <h5>
                                                    @translate(Kamu Belum Mempunyai Notifikasi Saat Ini)
                                                </h5>
                                            </li>
