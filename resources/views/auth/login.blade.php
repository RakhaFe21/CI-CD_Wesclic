...
<section class="breadcrumb-section">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h2>@translate(masuk )</h2>
                <div class="breadcrumb-link margin-top-10">
                    <span><a href="{{url('/')}}">@translate(home)</a> / @translate(masuk )</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="login-form">
                    <h3>@translate(masuk ke ) <span>@translate(akun)!</span></h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12  mb-2">
                            <button class="btn btn-primary  px-5 " type="button" id="instructor">Dinas</button>
                        </div>

                        <div class="col-md-4 col-sm-12  mb-2">
                            <button class="btn btn-primary px-5" type="button" id="student">Siswa</button>
                        </div>
                    </div>
                    @endif
                        ...
                        <div class="tab-one-content lost active">
                            <form method="post" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    <label for="loginEmail"><i class="fa fa-envelope"></i> @translate(Alamat
                                        Email)</label>
                                    <input class="form-control @error('email') is-invalid @enderror pl-2" type="email"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="pass" class="form-control @error('password') is-invalid @enderror pl-2"
                                ...
                                <div class="checkbox-forgotpass-area">
                                    <div class="checkbox-part">
                                        <input type="checkbox" id="remember" name="remember" {{ old('remember')
                                            ? 'checked' : '' }}>
                                        <label for="remember"> @translate(ingat saya)</label>
                                    </div>
                                ...
                                <div class="login-button margin-top-20">
                                    <button class="template-button" id="loginBtn" type="submit">@translate(Masuk
                                        akun)</button>
                                    <span>@translate(Buat akun)? <a
                                            href="{{route('student.register')}}">@translate(daftar)</a></span>
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <form method="post" action="{{ route('login') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-12  mb-2">
                                            <button class="btn btn-primary  px-5 " type="button"
                                                id="instructor">Dinas</button>
                                        </div>

                                        <div class="col-md-4 col-sm-12  mb-2">
                                            <button class="btn btn-primary px-5" type="button"
                                                id="student">Siswa</button>
                                        </div>
                                    </div>
                                    @endif
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <div class="custom-checkbox d-flex justify-content-between">
                                                <input type="checkbox" id="chb1" name="remember" {{ old('remember')
                                                    ? 'checked' : '' }}>
                                                <label for="chb1">@translate(Ingat Saya)</label>
                                                <a href="{{route('student.password.reset')}}" class="primary-color-2">
                                                    @translate(Lupa password)?</a>
                                            </div>
                                        </div>
                                    </div><!-- end col-md-12 -->
                                    <div class="col-lg-12 ">
                                        <div class="btn-box">
                                            <button class="theme-btn" id="loginBtn" type="submit">@translate(masuk
                                                akun)</button>
                                        </div>
                                    </div><!-- end col-md-12 -->
                                    <div class="col-lg-12">
