                                        ...
                                        <div class="our-post-item">
                                            ...
                                            <div class="our__text">
                                                <h4 class="widget-title">
                                                    {{number_format(\App\Model\Course::Published()->where('is_published',true)->count())}}
                            ...
                            <div class="card-item card-preview"
                                ...
                                <div class="card-content">
                                    ...
                                    <h3 class="card__title">
                                        <a
                                            href="{{route('course.single',$l_course->slug)}}">{{\Illuminate\Support\Str::limit($l_course->title,58)}}</a>
                                    </h3>
                                    ...
                                    <div class="rating-wrap d-flex mt-2 mb-3">
                                        <span class="star-rating-wrap">
                                            {{\Carbon\Carbon::parse($l_course->mulai)->format('d F Y')}} - <span
                                                class="star__count">{{\Carbon\Carbon::parse($l_course->berakhir)->format('d
                                                F Y')}}</span>
                                        </span>
                                    </div><!-- end rating-wrap -->
                                    <div class="rating-wrap d-flex mt-2 mb-3">
                                    ...
                                    <div class="card-price-wrap d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="#!" class="text-btn addToCart-{{$l_course->id}}"
                                            onclick="addToCart({{$l_course->id}},'{{route('add.to.cart')}}')">@translate(Ikuti
                                            Pelatihan)</a>
                                        @else
    ...
    <div id="tooltip_content_{{$l_c_tooltip->id}}">
        <div class="card-item">
            <div class="card-content">
                ...
                <h3 class="card__title">
                    <a
                        href="{{route('course.single',$l_c_tooltip->slug)}}">{{\Illuminate\Support\Str::limit($l_c_tooltip->title,58)}}</a>
                </h3>
                <p class="card__label">
                ...
                <div class="card-action">
                    <ul class="card-duration d-flex justify-content-between align-items-center">
                        <li><span class="meta__date"><i class="la la-play-circle"></i>
                                {{$l_c_tooltip->classes->count()}} @translate(Kelas Pelatihan)</span>
                        </li>
                        ...
                        <div class="category-content">
                            <div class="category-inner">
                                <h3 class="cat__title"><a
                                        href="{{route('course.category',$item->slug)}}">{{$item->name}}</a></h3>
                                <p class="cat__meta">{{$item->courses->count()}} @translate(Course(s))</p>
                                <a href="{{route('course.category',$item->slug)}}" class="theme-btn">@translate(explore
                                    now)</a>
                            </div>
    ...
    <div class="course-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading text-center">
                        <h5 class="section__meta">@translate(Pilih pelatihan anda)</h5>
                        <h2 class="section__title">@translate(Cari Pelatihan Terbaik Di Sini)</h2>
                        <span class="section-divider"></span>
                    </div><!-- end section-heading -->
                </div><!-- end col-lg-12 -->
            </div><!-- end row -->
                                    ...
                                    <div id="tooltip_content_{{$c_tooltip->id}}">
                                        <div class="card-item">
                                            <div class="card-content">
                                                ...
                                                <h3 class="card__title">
                                                    <a
                                                        href="{{route('course.single',$c_tooltip->slug)}}">{{\Illuminate\Support\Str::limit($c_tooltip->title,58)}}</a>
                                                </h3>
                                                <p class="card__label">
                                                    <span class="mr-1">@translate(di)</span><a
                        ...
                        <div class="course-carousel">
                            ...
                            <div class="card-item card-preview"
                                ...
                                <div class="card-content">
                                    ...
                                    <h3 class="card__title">
                                        <a
                                            href="{{route('course.single',$t_courses->slug)}}">{{\Illuminate\Support\Str::limit($t_courses->title,58)}}</a>
                                    </h3>
                                    <p class="card__author">
                                        <a
                                            href="{{route('single.instructor',$t_courses->slug)}}">{{$t_courses->name}}</a>
                                    </p>
                                    <div class="rating-wrap d-flex mt-2 mb-3">
                                        <span class="star-rating-wrap">
                                            @translate(Kategori) <span
                                    ...
                                    <div class="card-action">
                                        <ul class="card-duration d-flex justify-content-between align-items-center">
                                            <li>
                                                <span class="meta__date">
                                                    <i class="la la-play-circle"></i> {{$t_courses->classes->count()}}
                                    ...
                                    <div class="card-price-wrap d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="#!" class="text-btn addToCart-{{$t_courses->id}}"
                                            onclick="addToCart({{$t_courses->id}},'{{route('add.to.cart')}}')">@translate(Ikuti
                                            Pelatihan)</a>
                                        @else
                                        <a href="{{route('login')}}" class="text-btn">@translate(Ikuti Pelatihan)</a>
                                        @endif
    ...
    <div id="tooltip_content_{{$t_tooltip->id}}">
        <div class="card-item">
            <div class="card-content">
                ...
                <h3 class="card__title">
                    <a
                        href="{{route('course.single',$t_tooltip->slug)}}">{{\Illuminate\Support\Str::limit($t_tooltip->title,58)}}</a>
                </h3>
                <p class="card__label">
                    <span class="mr-1">@translate(di)</span><a
                ...
                <div class="card-action">
                    <ul class="card-duration d-flex justify-content-between align-items-center">
                        <li><span class="meta__date"><i class="la la-play-circle"></i> {{$t_tooltip->classes->count()}}
                                @translate(Kelas Pelatihan)</span>
                        </li>
                        <li><span class="meta__date">
                                @php
            ...
            <div class="col-lg-3 column-td-half">
                <div class="counter-item">
                    ...
                    <h4 class="count__title text-color-2 count-up" data-from="0"
                        data-to="{{\App\User::where('user_type','Instructor')->get()->count()}}" data-time="1000">0</h4>
            ...
            <div class="col-lg-3 column-td-half">
                <div class="counter-item">
                    ...
                    <h4 class="count__title  count__title text-color-2 count-up1" data-from="0"
                        data-to="{{\App\User::where('user_type','Student')->get()->count()}}" data-time="1000">0</h4>
                ...
                <div class="package-item package-item-active">
                    ...
                    <div class="btn-box">
                        <a href="{{ route('subscription.frontend', $subscription->duration) }}" class="theme-btn">{{
                            App\SubscriptionCourse::where('subscription_duration','LIKE','%'.$subscription->duration.'%')->count()
                            }} Courses</a>
                        <form action="{{ route('subscription.cart') }}" method="get">
                            ...
                            @foreach
                            (App\SubscriptionCourse::where('subscription_duration','LIKE','%'.$subscription->duration.'%')->get()
                            as $item)
