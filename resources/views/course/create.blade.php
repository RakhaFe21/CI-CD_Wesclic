...
<div class="card m-b-30">
        ...
        <form action="{{ route('course.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label class="col-lg-3 col-form-label" for="val-category_id">
                    @translate(Kategory) <span class="text-danger">*</span></label>
                <div class="col-lg-9">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <div class="input-group mb-3">
                        ...
                        @error('price') <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong>
                        </span> @enderror
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <div class="switchery-list">
                        ...
                        @error('is_free') <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong>
                        </span> @enderror
                    </div>
                </div>
            </div>
            ...
            <div id="auto_hide">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group mb-3">
                            <input type="date" value="{{ old('price') }}" name="tanggaltulis"
                                class="form-control @error('price') is-invalid @enderror">
                            @error('price') <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong>
                            </span> @enderror
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group mb-3">
                            <input type="time" value="{{ old('price') }}" name="jamtulis"
                                class="form-control @error('price') is-invalid @enderror">
                            @error('price') <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong>
                            </span> @enderror
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group mb-3">
                            <input type="text" value="{{ old('price') }}" name="lokasitulis"
                                class="form-control @error('price') is-invalid @enderror">
                            @error('price') <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong>
                            </span> @enderror
                        </div>
            ...
            <div id="auto_hide2">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group mb-3">
                            <input type="date" value="{{ old('price') }}" name="tanggalwawancara"
                                class="form-control @error('price') is-invalid @enderror">
                            @error('price') <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong>
                            </span> @enderror
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group mb-3">
                            <input type="time" value="{{ old('price') }}" name="jamwawancara"
                                class="form-control @error('price') is-invalid @enderror">
                            @error('price') <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong>
                            </span> @enderror
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group mb-3">
                            <input type="text" value="{{ old('price') }}" name="lokasiwawancara"
                                class="form-control @error('price') is-invalid @enderror">
                            @error('price') <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong>
                            </span> @enderror
                        </div>
            ...
            <div class="field_wrapper">
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        ...
                        @error('logbook') <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong>
                        </span> @enderror
                    </div>
    ...
    <div class="form-group row" style="display: none;">
        ...
        <div class="col-lg-8">
            ...
            @error('logbook') <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong> </span>
            @enderror
        </div>
