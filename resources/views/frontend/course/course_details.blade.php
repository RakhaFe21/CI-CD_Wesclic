  ...
  ================================= -->
    ...
    <div id="mobile-sidebar-feature" class="sidebar-widget sidebar-feature">
        ...
        <ul class="list-items">
            ...
            <li>
                <span><i class="la la-play-circle-o"></i>@translate(Mentor)</span>
                                                ...
                                                <div class="card-header" id="headingOne">
                                                    <h2 class="mb-0">
                                                        <button
                                                            ...
                                                            {{ $item->title }}
                                                            <span>{{ $item->contents->count() }} @translate(mentor)</span>
                                                        </button>
                                                    </h2>
                                                </div><!-- end card-header -->
                                                            ...
                                                            @forelse ($item->contents as $content)
                                                                <li>
                                                                  ...
                                                                  <span><i class="fa fa-play-circle mr-2"></i>{{ $content->title }}
                                                                      ...
                                                                      >@translate(Lihat)</span>
                                                                  @else
                                                                          <a href="javascript:void(0)"
                                                                             class="primary-color-2 d-flex align-items-center justify-content-between">
                                                                  <span><i class="fa fa-play-circle mr-2"></i>{{ $content->title }}
                                                                      <span class="badge-label badge-secondary">@translate(Terkunci)</span>
                                                                  @endif
                                            ...
                                            <div class="card-action">
                                                <ul class="card-duration d-flex justify-content-between align-items-center">
                                                    <li><span class="meta__date"><i
                                                                class="la la-play-circle"></i> {{$tooltip->classes->count()}} @translate(Kelas Pelatihan)</span>
                                                    </li>
                            ...
                            <div class="instructor-content margin-top-30px d-flex">
                                <div class="instructor-img">
                                    ...
                                    <ul class="list-items">
                                        ...
                                        <li><span
                                                class="la la-play-circle-o"></span> {{ \App\Model\Course::where('user_id',$s_course->id)->count() }}
                                            @translate(Pelatihan)
                                        </li>
                                        <li><span class="la la-eye"></span>
                                            <a href="{{route('single.instructor',$s_course->slug)}}">
                                                @translate(Lihat Semua Pelatihan)</a></li>
                                    </ul>
                                            ...
                                            <div class="card-content">
                                                ...
                                                <div class="card-action">
                                                    <ul class="card-duration d-flex justify-content-between align-items-center">
                                                        <li>
                                                          <span class="meta__date">
                                                              <i class="la la-play-circle"></i> {{$moreCourseItem->classes->count()}} @translate(Kelas Pelatihan)
                                                          </span>
                                                        </li>
                                                        <li>
                                                          <span class="meta__date">
                                                    ...
                                                    @auth()
                                                        @if(\Illuminate\Support\Facades\Auth::user()->user_type == 'Student')
                                                            <a href="#!" class="text-btn addToCart-{{$moreCourseItem->id}}"
                                                               onclick="addToCart({{$moreCourseItem->id}},'{{route('add.to.cart')}}')">@translate(Tambah ke keranjang)</a>
                                                        @else
                                                            <a href="{{route('login')}}" class="text-btn">@translate(Daftar)</a>
                                                        @endif
                                                    @endauth
                        ...
                        <div class="sidebar">
                            ...
                            <div class="sidebar-widget recent-widget">
                                ...
                                <div class="btn-box text-center">
                                    <a href="{{route('course.filter')}}" class="theme-btn d-block">@translate(Lihat semua pelatihan)</a>
                                </div><!-- end btn-box -->
                            </div><!-- end sidebar-widget -->
