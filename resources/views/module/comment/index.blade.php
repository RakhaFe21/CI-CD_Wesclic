...
<div class="card m-2">
    <div class="card-header">
        <div class="float-left">
            <h2 class="card-title">@translate(List Komentar Kursus)</h2>
        </div>
        ...
        <table class="table table-bordered table-hover text-center">
            <thead>
                <tr>
                    ...
                    <th>@translate(Komentar/ Terakhir dibalas)</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-left"><a target="_blank"
                            href="{{ route('course.show',[$item->course->id,$item->course->slug])}}">{{$item->course->title
                            ?? 'N/A'}}</a>
                    </td>
                    <td>
                        <a target="_blank" href="{{ route('comments.show', $item->id) }}">
                            ...
                            <span class="badge badge-dark">
                                {{ $item->replayLast->first()->user_id == \Illuminate\Support\Facades\Auth::id() ?
                                '@translate(Send)' : '@translate(Reply)'}}
                            </span>
                            @endif
                        </a>
